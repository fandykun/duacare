    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('organizer.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label text-lg">Jabatan</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="position" placeholder="Input Jabatan">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label text-lg">Nomor HP</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="phone_number" placeholder="Input No. HP - cth:08*****">
                    </div>
                </div>
